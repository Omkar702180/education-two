(function (window, document, $, undefined) {
    ...
    let WebDevelopersJs = {
        ...
        methods: function (e) {
            WebDevelopersJs.salActive();
            WebDevelopersJs.magnigyPopup();
            WebDevelopersJs.slickSlider();
            WebDevelopersJs.headerSticky();
            WebDevelopersJs.counterUp();
            WebDevelopersJs.productHoverTilt();
            WebDevelopersJs.masonryActivation();
            WebDevelopersJs.lightboxActivation();
            WebDevelopersJs.boxHover();
            WebDevelopersJs.boxHoverSlider();
            WebDevelopersJs.pricingPlan();
            WebDevelopersJs.wowActivation();
            WebDevelopersJs.qtyBtn();
            WebDevelopersJs.accordionBtnTwo();
            WebDevelopersJs.bannerAnimation();
            WebDevelopersJs.popupMobileMenu();
            WebDevelopersJs.searchPopup();
            WebDevelopersJs.bgMarque();
            WebDevelopersJs.filterClickButton();
            WebDevelopersJs.contactForm();
        },
        ...
        slickSlider: function () {
            ...
            $('.WebDevelopers-home-five-testimonial-activation').slick({
                dots: true,
                infinite: true,
                arrows: false,
                speed: 500,
            ...
            $('.WebDevelopers-course-details-related-course-carousel').slick({
                dots: false,
                infinite: true,
                arrows: false,
                speed: 1000,
            ...
            $('.WebDevelopers-course-carousel-page-with-dots').slick({
                dots: true,
                infinite: true,
                arrows: false,
                speed: 1000,
            ...
            $('.WebDevelopers-event-one-carousel-wrapper').slick({
                dots: true,
                infinite: true,
                arrows: false,
                speed: 1000,
        ...
        productHoverTilt: function () {
            if ( $.isFunction( $.fn.tilt ) ) {
                $( '.WebDevelopers-single-product-thumb-wrapper' ).tilt( {
                    maxTilt: 30,
                    perspective: 1000,
        ...
        boxHover: function(){
            jQuery( '.edu-instructor-3-visible, .WebDevelopers-hover-item-visible' ).on( 'mouseenter', function(){
                let selector = jQuery(this).parent().parent();
                selector.find( '.edu-instructor-3-visible, .WebDevelopers-hover-item-visible' ).removeClass( 'WebDevelopers-hover-active' );
                jQuery(this).addClass( 'WebDevelopers-hover-active' );
            });
        },
        ...
        boxHoverSlider: function(){
            jQuery( '.edu-instructor-3-slider-visible' ).on( 'mouseenter', function(){
                ...
                selector.find( '.edu-instructor-3-slider-visible' ).removeClass( 'WebDevelopers-hover-active' );
                jQuery(this).addClass( 'WebDevelopers-hover-active' );
            });
        },
        ...
        searchPopup: function () {
            ...
            $('.edu-search-popup .WebDevelopers-search-popup-field').on('click', function (e) {
                e.stopPropagation();
            })
        },
